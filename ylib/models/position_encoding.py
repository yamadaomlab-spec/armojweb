...
from ylib.util.misc import NestedTensor
...
class PositionEmbeddingLearned_1d(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        pos = y_emb.permute(1, 0).unsqueeze(0).repeat(x.shape[0], 1, 1)
        return pos #(bs, c, y)


def build_position_encoding_1d(args):
